...
function Search() {
  ...
  const renderFooter = () => {
    return (
      <View style={{ flex: 1, paddingVertical: 20, justifyContent: 'center', paddingBottom: 10 }}>
        {product.Products?.length !== 0 && product.isLoading && (
      ...
      <View style={styles.scrolles}>
        <View>
          ...
          <>
            ...
            {product.isLoading && product.Products?.length === 0 ? (
              <View
                style={{ justifyContent: 'center', alignItems: 'center', flex: 1, paddingTop: 200 }}
              >
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              >
                <Text
                  style={filter === 'foods' ? styles.buttonFilter : styles.button}
                  onPress={() => {
                    filter === 'foods' ? setFilter() : setFilter('foods');
                  }}
                >
                  Food
                </Text>
                ...
                <Text
                  style={filter === 'non coffee' ? styles.buttonFilter : styles.button}
                  onPress={() => {
                    filter === 'non coffee' ? setFilter() : setFilter('non coffee');
                  }}
                >
                  Non Coffee
                </Text>
              ...
              <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                ...
                <Text
                  style={sort === 'latest' ? styles.buttonFilter : styles.button}
                  onPress={() => {
                    sort === 'latest' ? setSort() : setSort('latest');
                  }}
                >
                  Latest
                </Text>
              ...
              <View style={{ flexDirection: 'row' }}>
                <Text
                  style={price === 'cheap' ? styles.buttonFilter : styles.button}
                  onPress={() => {
                    price === 'cheap' ? setPrice() : setPrice('cheap');
                  }}
                >
                  Cheap
                </Text>
                <Text
                  style={price === 'pricey' ? styles.buttonFilter : styles.button}
                  onPress={() => {
                    price === 'pricey' ? setPrice() : setPrice('pricey');
                  }}
                >
                  Pricey
                </Text>
