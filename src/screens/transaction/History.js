  ...
  const renderFooter = () => {
    return (
      <View style={{ flex: 1, paddingVertical: 20, justifyContent: 'center', paddingBottom: 10 }}>
        {transaction.history.length !== 0 && transaction.isLoading && (
          <ActivityIndicator size="large" color="black" />
        )}
        {transaction.history.length !== 0 && !transaction.nextHistory && (
          <Text style={{ textAlign: 'center', color: 'black', fontFamily: 'Poppins-Regular' }}>
                          ...
                          <View style={stylesModal.modalView}>
                            ...
                            <View style={{ display: 'flex', flexDirection: 'row' }}>
                              ...
                              <Pressable
                                style={[stylesModal.button, stylesModal.buttonClose]}
                                onPress={() => {
                                  deleteItems(item.transaction_id);
                                }}
                              >
